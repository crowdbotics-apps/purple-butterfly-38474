...
## Project Structure
    ...
    ├── purple_butterfly_38474  # Django project configurations
...
1. Clone this repo and `cd purple_butterfly_38474`
...
2. Clone this repo and `cd purple_butterfly_38474`
